...
/////////////////////////////////////////////////////////////////////////////////////
//
//	teleopBetter_v3 (6150's TeleOp program)
//
...
task main()
{
	while(true)
	{
		...
		while(joy1Btn(8) == 1)
		{
			...
			{
				int leftSpeed = joystick.joy1_y1 / 2; // sets the speed for the left side
			}

			getJoystickSettings(joystick);
			if ( -10 > joystick.joy1_y2 > -100 || 10 < joystick.joy1_y2 < 100) // if the value on base's y2 is not in the deadzone...
			{
				int rightSpeed = joystick.joy1_y2 / 2 // sets the speed for the right side
			}
